...
var headerRawDateStart = 1;//スプレッドシート１行目　日付開始地点
var headerRawDirection1 = 1;//スプレッドシート１行目 区分１
var headerRawDirection2 = 2;//スプレッドシート２行目　区分２
var headerRawDirectionTotal = 3;//スプレッドシート３行目　合計値
var startCol = 4;//スプレッドシート４列目
var startRaw = 2;//スプレッドシート２行目　予定抽出結果書き始め